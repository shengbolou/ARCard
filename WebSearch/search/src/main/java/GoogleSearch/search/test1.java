...
public class test1 {
	final static String apiKey = "AIzaSyDWXpb-DsxyXIUNua_G3f-dFq91aiKxwYA";
	final static String customSearchEngineKey = "013036536707430787589:_pqjad5hr1a&q";
	...
	public static void main(String[] args) throws Exception {
		...
		String url = buildSearchString("ibm", 1, 10);
